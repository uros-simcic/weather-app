...
- days scored: **31**
- mean MAE: **8.21**
- mean range error: **-11.52** (negative = forecast too flat)

| date | n_hours | mae | forecast_range | observed_range | range_error |
|---|---|---|---|---|---|
| 2026-09-23 | 4 | 10.813 | 17.94 | 39.0 | -21.06 |
...
- days scored: **31**
- mean MAE: **1.61**
- mean range error: **-2.49** (negative = forecast too flat)

| date | n_hours | mae | forecast_range | observed_range | range_error |
|---|---|---|---|---|---|
| 2026-09-23 | 4 | 0.695 | 6.66 | 7.0 | -0.34 |
